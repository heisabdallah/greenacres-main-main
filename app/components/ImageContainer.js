...
const ImageContainer = ({image, title, description, linkTitle}) => {
  return (
    <div className=" h-96 w-80 group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
            ...
            <div className="absolute inset-0 flex translate-y-[40%] flex-col items-start justify-end px-9 text-center transition-all duration-500 gap-6 pb-16 group-hover:translate-y-0">
              ...
              <p className="mb-3 text-sm font-light text-slate-100 opacity-0 transition-opacity duration-300 group-hover:opacity-100 text-start">{description}</p>
